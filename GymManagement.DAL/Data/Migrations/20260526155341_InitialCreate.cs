    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemperShips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemperShips_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemperShips_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemperShips_MemberId",
                table: "MemperShips",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_MemperShips_PlanId",
                table: "MemperShips",
                column: "PlanId");
